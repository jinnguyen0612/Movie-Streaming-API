...
firebase_admin.initialize_app(cred, {'storageBucket': 'moviestreaming-a0fc2.appspot.com'})
...
async def upload_video(video_file: UploadFile = File(...)):
    try:
        ...
        return {"message": "Upload success","public_id": public_id, "secure_url": secure_url}
    except Exception as e:
